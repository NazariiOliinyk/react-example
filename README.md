## :rotating_light: :rotating_light: :rotating_light: This repo is just a dummy. Submit issues [in monorepo](https://github.com/tolgee/tolgee-js) or [check the source code here](https://github.com/tolgee/tolgee-js/tree/main/testapps/react). :rotating_light::rotating_light: :rotating_light:
